...
<%@ page language="java" contentType="text/html; charset=UTF-8"
            ...
            <div class="row">
                <div class="col-lg-12">
                	<div class="panel panel-default">
                        ...
                        <button id='regbtn' type="button" class="btn btn-xs pull-right">게시물 작성</button>
                         </div>
                        <!-- /.panel-heading -->
                             ...
                             <div class="col-lg-12">
                        		<form action="/board/list" id="searchForm" method="get">
                        			<select name="type">
                        				...
                        				<option value="TC"
                        				<c:out value="${pageMaker.cri.type eq 'TC' ? 'selected' : ''}"/>> 내용</option>
                        				<option value="TW"
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			//register 에서 넘어온  result, boardController 에서 정의했음
			//result = board.getBno
